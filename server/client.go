...
func (cf *clientFlag) clear(c clientFlag) {
	fmt.Println("[clear]", "client.start")
...
func (cf clientFlag) isSet(c clientFlag) bool {
	fmt.Println("[isSet]", "client.start")
...
func (cf *clientFlag) setIfNotSet(c clientFlag) bool {
	fmt.Println("[setIfNotSet]", "client.start")
...
func (c *client) String() (id string) {
	fmt.Println("[String]", "client.start")
...
func (c *client) GetNonce() []byte {
	fmt.Println("[GetNonce]", "client.start")
...
func (c *client) GetName() string {
	fmt.Println("[GetName]", "client.start")
...
func (c *client) GetOpts() *ClientOpts {
	fmt.Println("[GetOpts]", "client.start")
...
func (c *client) GetTLSConnectionState() *tls.ConnectionState {
	fmt.Println("[GetTLSConnectionState]", "client.start")
...
func (c *client) clientType() int {
	fmt.Println("[clientType]", "client.start")
...
func (c *client) clientTypeString() string {
	fmt.Println("[clientTypeString]", "client.start")
...
func (s *subscription) close() {
	fmt.Println("[close]", "client.start")
...
func (s *subscription) isClosed() bool {
	fmt.Println("[isClosed]", "client.start")
...
func (c *client) setTraceLevel() {
	fmt.Println("[setTraceLevel]", "client.start")
...
func (c *client) initClient() {
	fmt.Println("[initClient]", "client.start")
...
func (c *client) RemoteAddress() net.Addr {
	fmt.Println("[RemoteAddress]", "client.start")
...
func (c *client) reportErrRegisterAccount(acc *Account, err error) {
	fmt.Println("[reportErrRegisterAccount]", "client.start")
...
func (c *client) registerWithAccount(acc *Account) error {
	fmt.Println("[registerWithAccount]", "client.start")
...
func (c *client) applyAccountLimits() {
	fmt.Println("[applyAccountLimits]", "client.start")
...
func (c *client) RegisterUser(user *User) {
	fmt.Println("[RegisterUser]", "client.start")
...
func (c *client) RegisterNkeyUser(user *NkeyUser) error {
	fmt.Println("[RegisterNkeyUser]", "client.start")
...
func splitSubjectQueue(sq string) ([]byte, []byte, error) {
	fmt.Println("[splitSubjectQueue]", "client.start")
...
func (c *client) setPermissions(perms *Permissions) {
	fmt.Println("[setPermissions]", "client.start")
...
func (c *client) mergeDenyPermissions(what denyType, denyPubs []string) {
	fmt.Println("[mergeDenyPermissions]", "client.start")
...
func (c *client) mergeDenyPermissionsLocked(what denyType, denyPubs []string) {
	fmt.Println("[mergeDenyPermissionsLocked]", "client.start")
...
func (c *client) setExpiration(claims *jwt.ClaimsData, validFor time.Duration) {
	fmt.Println("[setExpiration]", "client.start")
...
func (c *client) loadMsgDenyFilter() {
	fmt.Println("[loadMsgDenyFilter]", "client.start")
...
func (c *client) writeLoop() {
	fmt.Println("[writeLoop]", "client.start")
...
func (c *client) flushClients(budget time.Duration) time.Time {
	fmt.Println("[flushClients]", "client.start")
...
func (c *client) readLoop(pre []byte) {
	fmt.Println("[readLoop]", "client.start")
...
func closedStateForErr(err error) ClosedState {
	fmt.Println("[closedStateForErr]", "client.start")
...
func (c *client) collapsePtoNB() (net.Buffers, int64) {
	fmt.Println("[collapsePtoNB]", "client.start")
...
func (c *client) handlePartialWrite(pnb net.Buffers) {
	fmt.Println("[handlePartialWrite]", "client.start")
...
func (c *client) flushOutbound() bool {
	fmt.Println("[flushOutbound]", "client.start")
...
func (c *client) handleWriteTimeout(written, attempted int64, numChunks int) bool {
	fmt.Println("[handleWriteTimeout]", "client.start")
...
func (c *client) markConnAsClosed(reason ClosedState) {
	fmt.Println("[markConnAsClosed]", "client.start")
...
func (c *client) flushSignal() {
	fmt.Println("[flushSignal]", "client.start")
	c.out.sg.Signal()
}
...
func (c *client) traceMsg(msg []byte) {
	fmt.Println("[traceMsg]", "client.start")
...
func (c *client) traceInOp(op string, arg []byte) {
	fmt.Println("[traceInOp]", "client.start")
	c.traceOp("<<- %s", op, arg)
}
...
func (c *client) traceOutOp(op string, arg []byte) {
	fmt.Println("[traceOutOp]", "client.start")
	c.traceOp("->> %s", op, arg)
}

func (c *client) traceOp(format, op string, arg []byte) {
	fmt.Println("[traceOp]", "client.start")
	opa := []interface{}{}
	if op != "" {
		opa = append(opa, op)
	}
...
func (c *client) processInfo(arg []byte) error {
	fmt.Println("[processInfo]", "client.start")
	info := Info{}
...
func (c *client) processErr(errStr string) {
	fmt.Println("[processErr]", "client.start")
	close := true
	switch c.kind {
	case CLIENT:
...
func removePassFromTrace(arg []byte) []byte {
	fmt.Println("[removePassFromTrace]", "client.start")
...
func computeRTT(start time.Time) time.Duration {
	fmt.Println("[computeRTT]", "client.start")
...
func (c *client) processConnect(arg []byte) error {
	fmt.Println("[processConnect]", "client.start")
...
func (c *client) maxAccountConnExceeded() {
	fmt.Println("[maxAccountConnExceeded]", "client.start")
...
func (c *client) maxPayloadViolation(sz int, max int32) {
	fmt.Println("[maxPayloadViolation]", "client.start")
...
func (c *client) queueOutbound(data []byte) {
	fmt.Println("[queueOutbound]", "client.start")
...
func (c *client) enqueueProtoAndFlush(proto []byte, doFlush bool) {
	fmt.Println("[enqueueProtoAndFlush]", "client.start")
	if c.isClosed() {
		return
	}
...
func (c *client) sendProtoNow(proto []byte) {
	fmt.Println("[sendProtoNow]", "client.start")
...
func (c *client) enqueueProto(proto []byte) {
	fmt.Println("[enqueueProto]", "client.start")
	c.enqueueProtoAndFlush(proto, false)
}

// Assume the lock is held upon entry.
func (c *client) sendPong() {
	fmt.Println("[sendPong]", "client.start")
	if c.trace {
...
func (c *client) sendRTTPing() bool {
	fmt.Println("[sendRTTPing]", "client.start")
	c.mu.Lock()
...
func (c *client) sendRTTPingLocked() bool {
	fmt.Println("[sendRTTPingLocked]", "client.start")
	if c.isMqtt() {
		return false
	}
...
func (c *client) sendPing() {
	fmt.Println("[sendPing]", "client.start")
...
func (c *client) generateClientInfoJSON(info Info) []byte {
	fmt.Println("[generateClientInfoJSON]", "client.start")
	info.CID = c.cid
...
func (c *client) sendErr(err string) {
	fmt.Println("[sendErr]", "client.start")
	c.mu.Lock()
	if c.trace {
...
func (c *client) sendOK() {
	fmt.Println("[sendOK]", "client.start")
	c.mu.Lock()
	if c.trace {
		c.traceOutOp("OK", nil)
	}
...
func (c *client) processPing() {
	fmt.Println("[processPing]", "client.start")
	c.mu.Lock()
...
func (c *client) processPong() {
	fmt.Println("[processPong]", "client.start")
	c.mu.Lock()
	c.ping.out = 0
...
func (c *client) msgParts(data []byte) (hdr []byte, msg []byte) {
	fmt.Println("[msgParts]", "client.start")
	if c != nil && c.pa.hdr > 0 {
...
func (c *client) processHeaderPub(arg []byte) error {
	fmt.Println("[processHeaderPub]", "client.start")
	if !c.headers {
...
func (c *client) processPub(arg []byte) error {
	fmt.Println("[processPub]", "client.start")
	// Unroll splitArgs to avoid runtime/heap issues
	a := [MAX_PUB_ARGS][]byte{}
	args := a[:0]
	start := -1
...
func splitArg(arg []byte) [][]byte {
	fmt.Println("[splitArg]", "client.start")
	a := [MAX_MSG_ARGS][]byte{}
	args := a[:0]
	start := -1
	for i, b := range arg {
...
func (c *client) parseSub(argo []byte, noForward bool) error {
	fmt.Println("[parseSub]", "client.start")
...
func (c *client) processSub(subject, queue, bsid []byte, cb msgHandler, noForward bool) (*subscription, error) {
	fmt.Println("[processSub]", "client.start")
...
func (c *client) processSubEx(subject, queue, bsid []byte, cb msgHandler, noForward, si, rsi bool) (*subscription, error) {
	fmt.Println("[processSubEx]", "client.start")
...
func (c *client) addShadowSubscriptions(acc *Account, sub *subscription) error {
	fmt.Println("[addShadowSubscriptions]", "client.start")
	if acc == nil {
...
func (c *client) addShadowSub(sub *subscription, ime *ime) (*subscription, error) {
	fmt.Println("[addShadowSub]", "client.start")
...
func (c *client) canSubscribe(subject string, optQueue ...string) bool {
	fmt.Println("[canSubscribe]", "client.start")
	if c.perms == nil {
		return true
	}
...
func queueMatches(queue string, qsubs [][]*subscription) bool {
	fmt.Println("[queueMatches]", "client.start")
	if len(qsubs) == 0 {
		return true
	}
...
func (c *client) unsubscribe(acc *Account, sub *subscription, force, remove bool) {
	fmt.Println("[unsubscribe]", "client.start")
	c.mu.Lock()
...
func (c *client) processUnsub(arg []byte) error {
	fmt.Println("[processUnsub]", "client.start")
	args := splitArg(arg)
	var sid []byte
	max := int64(-1)
...
func (c *client) checkDenySub(subject string) bool {
	fmt.Println("[checkDenySub]", "client.start")
...
func (c *client) msgHeaderForRouteOrLeaf(subj, reply []byte, rt *routeTarget, acc *Account) []byte {
	fmt.Println("[msgHeaderForRouteOrLeaf]", "client.start")
...
func (c *client) msgHeader(subj, reply []byte, sub *subscription) []byte {
	fmt.Println("[msgHeader]", "client.start")
...
func (c *client) stalledWait(producer *client) {
	fmt.Println("[stalledWait]", "client.start")
	stall := c.out.stc
...
func stallDuration(pb, mp int64) time.Duration {
	fmt.Println("[stallDuration]", "client.start")
...
func (c *client) deliverMsg(prodIsMQTT bool, sub *subscription, acc *Account, subject, reply, mh, msg []byte, gwrply bool) bool {
	fmt.Println("[deliverMsg]", "client.start")
	if sub.client == nil {
		return false
	}
	client := sub.client
...
func (c *client) addToPCD(client *client) {
	fmt.Println("[addToPCD]", "client.start")
...
func (c *client) trackRemoteReply(subject, reply string) {
	fmt.Println("[trackRemoteReply]", "client.start")
	a := c.acc
	if a == nil {
		return
	}
...
func (c *client) pruneRemoteTracking() {
	fmt.Println("[pruneRemoteTracking]", "client.start")
...
func (c *client) pruneReplyPerms() {
	fmt.Println("[pruneReplyPerms]", "client.start")
...
func (c *client) pruneDenyCache() {
	fmt.Println("[pruneDenyCache]", "client.start")
	r := 0
...
func (c *client) prunePubPermsCache() {
	fmt.Println("[prunePubPermsCache]", "client.start")
...
func (c *client) pubAllowed(subject string) bool {
	fmt.Println("[pubAllowed]", "client.start")
...
func (c *client) pubAllowedFullCheck(subject string, fullCheck, hasLock bool) bool {
	fmt.Println("[pubAllowedFullCheck]", "client.start")
...
func isServiceReply(reply []byte) bool {
	fmt.Println("[isServiceReply]", "client.start")
...
func isReservedReply(reply []byte) bool {
	fmt.Println("[isReservedReply]", "client.start")
...
func (c *client) processInboundMsg(msg []byte) {
	fmt.Println("[processInboundMsg]", "client.start")
	switch c.kind {
	case CLIENT:
...
func (c *client) selectMappedSubject() bool {
	fmt.Println("[selectMappedSubject]", "client.start")
...
func (c *client) processInboundClientMsg(msg []byte) (bool, bool) {
	fmt.Println("[processInboundClientMsg]", "client.start")
	// Update statistics
	// The msg includes the CR_LF, so pull back out for accounting.
	c.in.msgs++
...
func (c *client) subForReply(reply []byte) *subscription {
	fmt.Println("[subForReply]", "client.start")
...
func (c *client) handleGWReplyMap(msg []byte) bool {
	fmt.Println("[handleGWReplyMap]", "client.start")
...
func (c *client) setupResponseServiceImport(acc *Account, si *serviceImport, tracking bool, header http.Header) *serviceImport {
	fmt.Println("[setupResponseServiceImport]", "client.start")
...
func removeHeaderIfPresent(hdr []byte, key string) []byte {
	fmt.Println("[removeHeaderIfPresent]", "client.start")
...
func genHeader(hdr []byte, key, value string) []byte {
	fmt.Println("[getHeader]", "client.start")
	var bb bytes.Buffer
...
func (c *client) setHeader(key, value string, msg []byte) []byte {
	fmt.Println("[setHeader]", "client.start")
	var bb bytes.Buffer
	var omi int
...
func (c *client) processServiceImport(si *serviceImport, acc *Account, msg []byte) {
	fmt.Println("[processServiceImport]", "client.start")
...
func (c *client) addSubToRouteTargets(sub *subscription) {
	fmt.Println("[addSubToRouteTargets]", "client.start")
	if c.in.rts == nil {
...
func (c *client) processMsgResults(acc *Account, r *SublistResult, msg, deliver, subject, reply []byte, flags int) (bool, [][]byte) {
	fmt.Println("[processMsgResults]", "client.start")
...
func (c *client) checkLeafClientInfoHeader(msg []byte) (dmsg []byte, setHdr bool) {
	fmt.Println("[checkLeafClientInfoHeader]", "client.start")
...
func (c *client) pubPermissionViolation(subject []byte) {
	fmt.Println("[pubPermissionViolation]", "client.start")
...
func (c *client) subPermissionViolation(sub *subscription) {
	fmt.Println("[subPermissionViolation]", "client.start")
...
func (c *client) replySubjectViolation(reply []byte) {
	fmt.Println("[replySubjectViolation]", "client.start")
...
func (c *client) maxTokensViolation(sub *subscription) {
	fmt.Println("[maxTokensViolation]", "client.start")
...
func (c *client) processPingTimer() {
	fmt.Println("[processPingTimer]", "client.start")
	c.mu.Lock()
	c.ping.tmr = nil
...
func adjustPingIntervalForGateway(d time.Duration) time.Duration {
	fmt.Println("[adjustPingIntervalForGateway]", "client.start")
...
func (c *client) setPingTimer() {
	fmt.Println("[setPingTimer]", "client.start")
	if c.srv == nil {
		return
	}
...
func (c *client) clearPingTimer() {
	fmt.Println("[clearPingTimer]", "client.start")
	if c.ping.tmr == nil {
		return
	}
	c.ping.tmr.Stop()
...
func (c *client) clearTlsToTimer() {
	fmt.Println("[clearTlsToTimer]", "client.start")
	if c.tlsTo == nil {
		return
	}
	c.tlsTo.Stop()
...
func (c *client) setAuthTimer(d time.Duration) {
	fmt.Println("[setAuthTimer]", "client.start")
	c.atmr = time.AfterFunc(d, c.authTimeout)
}

// Lock should be held
func (c *client) clearAuthTimer() bool {
	fmt.Println("[clearAuthTimer()]", "client.start")
	if c.atmr == nil {
		return true
	}
	stopped := c.atmr.Stop()
...
func (c *client) awaitingAuth() bool {
	fmt.Println("[awaitingAuth]", "client.start")
...
func (c *client) setExpirationTimer(d time.Duration) {
	fmt.Println("[setExpirationTimer]", "client.start")
	c.mu.Lock()
...
func (c *client) flushAndClose(minimalFlush bool) {
	fmt.Println("[flushAndClose]", "client.start")
...
func (c *client) kindString() string {
	fmt.Println("[kindString]", "client.start")
...
func (c *client) swapAccountAfterReload() {
	fmt.Println("[swapAccountAfterReload]", "client.start")
	c.mu.Lock()
	defer c.mu.Unlock()
	if c.srv == nil {
		return
...
func (c *client) processSubsOnConfigReload(awcsti map[string]struct{}) {
	fmt.Println("[processSubsOnConfigReload]", "client.start")
	c.mu.Lock()
	var (
...
func (c *client) closeConnection(reason ClosedState) {
	fmt.Println("[closeConnection]", "client.start")
	c.mu.Lock()
...
func (c *client) reconnect() {
	fmt.Println("[reconnect]", "client.start")
	var (
		retryImplicit bool
		gwName        string
		gwIsOutbound  bool
...
func (c *client) setNoReconnect() {
	fmt.Println("[setNoReconnect]", "client.start")
	c.mu.Lock()
...
func (c *client) getRTTValue() time.Duration {
	fmt.Println("[getRTTValue]", "client.start")
	c.mu.Lock()
	rtt := c.rtt
	c.mu.Unlock()
	return rtt
...
func (c *client) getAccAndResultFromCache() (*Account, *SublistResult) {
	fmt.Println("[getAccAndResultFromCache]", "client.start")
	var (
		acc *Account
		pac *perAccountCache
		r   *SublistResult
...
func (c *client) Account() *Account {
	fmt.Println("[Account]", "client.start")
	if c == nil {
		return nil
	}
	c.mu.Lock()
...
func (c *client) prunePerAccountCache() {
	fmt.Println("[prunePerAccountCache]", "client.start")
	n := 0
...
func (c *client) pruneClosedSubFromPerAccountCache() {
	fmt.Println("[pruneClosedSubFromPerAccountCache]", "client.start")
...
func (ci *ClientInfo) serviceAccount() string {
	fmt.Println("[serviceAccount]", "client.start")
	if ci == nil {
		return _EMPTY_
	}
...
func (c *client) addServerAndClusterInfo(ci *ClientInfo) {
	fmt.Println("[addServerAndClusterInfo]", "client.start")
...
func (c *client) getClientInfo(detailed bool) *ClientInfo {
	fmt.Println("[getClientInfo]", "client.start")
...
func (c *client) doTLSServerHandshake(typ string, tlsConfig *tls.Config, timeout float64, pCerts PinnedCertSet) error {
	fmt.Println("[doTLSClientHandshake]", "client.start")
...
func (c *client) doTLSHandshake(typ string, solicit bool, url *url.URL, tlsConfig *tls.Config, tlsName string, timeout float64, pCerts PinnedCertSet) (bool, error) {
	fmt.Println("[doTLSHandshake]", "client.start")
	var host string
...
func (c *client) getRawAuthUser() string {
	fmt.Println("[getRawAuthUser]", "client.start")
	switch {
	case c.opts.Nkey != "":
		return c.opts.Nkey
...
func (c *client) getAuthUser() string {
	fmt.Println("[getAuthUser]", "client.start")
	switch {
	case c.opts.Nkey != "":
...
func convertAllowedConnectionTypes(cts []string) (map[string]struct{}, error) {
	fmt.Println("[convertAllowedConnectionTypes]", "client.start")
	var unknown []string
...
func (c *client) connectionTypeAllowed(acts map[string]struct{}) bool {
	fmt.Println("[connectionTypeAllowed]", "client.start")
...
func (c *client) Error(err error) {
	fmt.Println("[Error]", "client.start")
	c.srv.Errors(c, err)
}

func (c *client) Errorf(format string, v ...interface{}) {
	fmt.Println("[Errorf]", "client.start")
	format = fmt.Sprintf("%s - %s", c, format)
	c.srv.Errorf(format, v...)
}

func (c *client) Debugf(format string, v ...interface{}) {
	fmt.Println("[Debugf]", "client.start")
...
func (c *client) setFirstPingTimer() {
	fmt.Println("[setFirstPingTimer]", "client.start")
